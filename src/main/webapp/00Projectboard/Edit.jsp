...
<body>
    ...
    <div class="container mt-5 ">
     ...
     <form name="writeFrm" method="post" class="form-inline" enctype="multipart/form-data"
    ...
    <table class="table" style="text-align: center">
        ...
        <tr>
            ...
            <td>
                <select class="form-select" name="category"
						...
						<option value="${ dto.category }" >카테고리를 선택하세요</option>
				</select>
            </td>
        </tr>
        <tr>
        ...
        <div class="col d-flex justify-content-center">
            <button type="button" class="btn btn-light" onclick="location.href='../board/list.do';">더 많은 상품보기</button>
        </div>
        <br>
     <div class="container mt-5 ">
