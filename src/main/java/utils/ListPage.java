	...
	public static String pagingStr(int totalCount, int pageSize, int blockPage,
		...
		if (pageTemp != 1) {
	        ...
	        pagingStr.append("<a class='page-link' href='" 
	        		+ reqUrl + "?pageNum=1'><i class='bi bi-skip-backward-fill'></i></a>");
	        pagingStr.append("</li>");
	        
	        pagingStr.append("<li class=\"page-item\">");
	        pagingStr.append("<a class='page-link' href='" 
	        		+ reqUrl + "?pageNum="+ (pageTemp - 1)+"'><i class='bi bi-skip-start-fill'></i></a>"); 
	        pagingStr.append("</li>");
        }
		int blockCount = 1;
		...
		if (pageTemp <= totalPages) {
			...
			pagingStr.append("<li class=\"page-item\">");
			pagingStr.append("<a class='page-link' href='" + reqUrl 
